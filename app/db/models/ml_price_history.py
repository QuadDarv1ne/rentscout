...
class MLPriceHistory(Base):
    ...
    # Source information
    source = Column(String(50), nullable=True)  # avito, cian, etc.
    external_id = Column(String(255), nullable=True)  # Link to original property
    
    # Property type and verification
    property_type = Column(String(50), default="apartment")  # apartment, house, etc.
    is_verified = Column(Integer, default=0)  # Boolean: 0 or 1 for compatibility
    ...
    is_active = Column(Integer, default=1)  # 1 = active, 0 = inactive listing

...
# ============ ALERT ROUTES (must be before /{property_id} to avoid conflict) ============
...
async def delete_property_alert(
    ...
    if db is None:
        ...
        return OperationStatus(status="ok", message="Alert deleted successfully")
...
async def deactivate_property_alert(
    ...
    if db is None:
        ...
        return OperationStatus(status="ok", message="Alert deactivated successfully")
